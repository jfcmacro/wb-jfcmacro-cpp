...
UnderflowException::UnderflowException(char* men) : mensaje(men) {
}

UnderflowException::UnderflowException(): mensaje("No hay datos en la pila") {
}

ostream&
operator<<(ostream &out, UnderflowException &nme) {
    out << nme.mensaje << endl;
    return out;
}
